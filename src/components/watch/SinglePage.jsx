          ...
          <section className='singlePage'>
            ...
            <div className='container'>
              ...
              <div className='soical'>
                <h3>Share : </h3>
                <img alt="" src='https://img.icons8.com/color/48/000000/facebook-new.png' />
                <img alt="" src='https://img.icons8.com/fluency/48/000000/twitter-circled.png' />
                <img alt="" src='https://img.icons8.com/fluency/48/000000/linkedin-circled.png' />
              </div>
            </div>
          </section>
